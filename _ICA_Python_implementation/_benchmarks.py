...
# Default is 10 dimensions. You can change this in run_experiments.py.
#
...
#
# WHY A REGISTRY?
# Instead of writing if/else chains everywhere, we look things up in one place.
...
# QUICK SELF-TEST
# -----------------------------------------------------------------------------
# Run this file directly (python benchmarks.py) to verify all 7 functions
